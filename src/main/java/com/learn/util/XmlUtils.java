...
public class XmlUtils {
     ...
     * @return xml
     */
    public static String textMessageToXml(TextMessage textMessage) throws Exception{
     ...
     * @return xml
     */
    public static String musicMessageToXml(MusicMessage musicMessage) throws Exception{
